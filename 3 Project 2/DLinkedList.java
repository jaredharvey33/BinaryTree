 ...
 *
 * @param <E>
 *            Class to initialize the DlinkedList
 *
 * @version 2020.11.24
 *
 * @param <E>
...
public class DLinkedList<E> {
     ...
     */
    private void init() {
        head = new DLinkedList.Node<E>(null);
        tail = new DLinkedList.Node<E>(null);
        head.setNext(tail);
    ...
    public String toString() {
        StringBuilder builder = new StringBuilder("Free Block List:");
        if (!isEmpty()) {
            int i = 1;
    ...
    private class DLListIterator<A> implements Iterator<E> {
        ...
        @Override
        public void remove() {
            if (node.equals(head) || !node.previous().next().equals(node)) {
                throw new IllegalStateException(
                    "next has not been called or it is already removed.");
            }
