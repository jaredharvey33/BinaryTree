...
public class RecordTest extends student.TestCase {
    ...
    public void testIntsArray() {
        ArrayList<Integer> al = r1.intsArray();
        assertEquals((int)al.get(0), 1);
        assertEquals((int)al.get(1), 1);
        assertEquals((int)al.get(2), 1);
        assertEquals((int)al.get(3), 1);
        assertEquals((int)al.get(4), 1);
        assertEquals((int)al.get(5), 1);
        assertEquals((int)al.get(6), 1);
